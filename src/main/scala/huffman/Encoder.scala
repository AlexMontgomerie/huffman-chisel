...
class Encoder[T <: UInt](gen: T, size: Int, code_width: Int, len_width: Int, code_file: String, len_file: String) extends Module {
...
class BufferedEncoder[T <: UInt](gen: T, size: Int, code_width: Int, len_width: Int, code_file: String, len_file: String) extends Module {

  // initialise IO
  val io = IO(new EncoderIO(gen))

  // initialise encoder
  val encoder = Module( new Encoder[T](gen, size, code_width, len_width, code_file, len_file) )
  ...
  // io.in.ready := RegNext(encoder.io.in.ready)
